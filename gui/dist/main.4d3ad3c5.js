...
},{"symbol-observable":"../node_modules/symbol-observable/es/index.js"}],"scripts/modules/pairwise.ts":[function(require,module,exports) {
"use strict";
...
var PairwiseActionType = exports.PairwiseActionType = undefined;
(function (PairwiseActionType) {
    PairwiseActionType["ROW_WAS_ADDED"] = "model/row/add";
    PairwiseActionType["ROW_WAS_DELETED"] = "model/row/delete";
    PairwiseActionType["COL_WAS_ADDED"] = "model/col/add";
    PairwiseActionType["COL_WAS_UPDATED"] = "model/col/update";
    PairwiseActionType["COL_WAS_DELETED"] = "model/col/delete";
    PairwiseActionType["NAME_WAS_UPDATED"] = "model/name/update";
    PairwiseActionType["SUBMITED"] = "model/submit";
})(PairwiseActionType || (exports.PairwiseActionType = PairwiseActionType = {}));
var defaultModel = { name: "", values: [""] };
var initPairwiseStore = exports.initPairwiseStore = function initPairwiseStore() {
    return {
        models: [defaultModel]
    };
};
function pairwiseReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initPairwiseStore();
    var action = arguments[1];

    switch (action.type) {
        case PairwiseActionType.ROW_WAS_ADDED:
            return Object.assign({}, state, { models: [].concat(_toConsumableArray(state.models), [defaultModel]) });
        case PairwiseActionType.ROW_WAS_DELETED:
            return Object.assign({}, state, { models: state.models.filter(function (_, i) {
                    return i !== action.payload.rowIndex;
                }) });
        case PairwiseActionType.COL_WAS_ADDED:
            return Object.assign({}, state, { models: state.models.map(function (m, i) {
                    return i === action.payload.rowIndex ? Object.assign({}, m, { values: [].concat(_toConsumableArray(m.values), [""]) }) : m;
                }) });
        case PairwiseActionType.COL_WAS_UPDATED:
            return Object.assign({}, state, { models: updateRow(state.models, action.payload.rowIndex, function (r) {
                    return Object.assign({}, r, { values: r.values.map(function (v, i) {
                            return i === action.payload.colIndex ? action.payload.value : v;
                        }) });
                }) });
        case PairwiseActionType.COL_WAS_DELETED:
            return Object.assign({}, state, { models: updateRow(state.models, action.payload.rowIndex, function (r) {
                    return Object.assign({}, r, { values: r.values.filter(function (v, i) {
                            return i !== action.payload.colIndex;
                        }) });
                }) });
        case PairwiseActionType.NAME_WAS_UPDATED:
            return Object.assign({}, state, { models: updateRow(state.models, action.payload.rowIndex, function (r) {
                    return Object.assign({}, r, { name: action.payload.name });
                }) });
        default:
            return state;
    }
}
function updateRow(rows, rowIndex, fn) {
    return [].concat(_toConsumableArray(rows.slice(0, Math.max(0, rowIndex))), [fn(rows[rowIndex])], _toConsumableArray(rows.slice(Math.min(rowIndex + 1, rows.length))));
}
...
var deleteRow = exports.deleteRow = function deleteRow(rowIndex) {
    return {
...
var addCol = exports.addCol = function addCol(rowIndex) {
    return {
...
var updateCol = exports.updateCol = function updateCol(rowIndex, colIndex, value) {
    return {
...
var deleteCol = exports.deleteCol = function deleteCol(rowIndex, colIndex) {
    return {
...
var updateRowName = exports.updateRowName = function updateRowName(rowIndex, name) {
    return {
...
},{"./components/Provider":"../node_modules/react-redux/es/components/Provider.js","./components/connectAdvanced":"../node_modules/react-redux/es/components/connectAdvanced.js","./connect/connect":"../node_modules/react-redux/es/connect/connect.js"}],"scripts/components/colForm.tsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ColForm = undefined;
...
var ColForm = exports.ColForm = function (_React$PureComponent) {
    _inherits(ColForm, _React$PureComponent);

    function ColForm() {
        _classCallCheck(this, ColForm);

        var _this = _possibleConstructorReturn(this, (ColForm.__proto__ || Object.getPrototypeOf(ColForm)).apply(this, arguments));

        _this.onChange = function (e) {
            _this.props.onChange(_this.props.rowIndex, _this.props.colIndex, e.currentTarget.value);
        };
        return _this;
    }

    _createClass(ColForm, [{
        key: "render",
        value: function render() {
            return React.createElement("input", { value: this.props.value, onChange: this.onChange });
        }
    }]);

    return ColForm;
}(React.PureComponent);
},{"react":"../node_modules/react/index.js"}],"scripts/containers/colFormContainer.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ColFormContainer = undefined;

var _reactRedux = require("react-redux");

var _colForm = require("../components/colForm");

var _pairwise = require("../modules/pairwise");

var stateToProps = function stateToProps(store, ownProps) {
    return {
        value: store.pairwise.models[ownProps.rowIndex].values[ownProps.colIndex]
    };
};
var dispatchToProps = {
    onChange: _pairwise.updateCol
};
var ColFormContainer = exports.ColFormContainer = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(_colForm.ColForm);
},{"react-redux":"../node_modules/react-redux/es/index.js","../components/colForm":"scripts/components/colForm.tsx","../modules/pairwise":"scripts/modules/pairwise.ts"}],"scripts/components/rowForm.tsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RowForm = undefined;
...
var _colFormContainer = require("../containers/colFormContainer");
...
var RowForm = exports.RowForm = function (_React$PureComponent) {
    _inherits(RowForm, _React$PureComponent);

    function RowForm() {
        _classCallCheck(this, RowForm);

        var _this = _possibleConstructorReturn(this, (RowForm.__proto__ || Object.getPrototypeOf(RowForm)).apply(this, arguments));

        _this.onNameUpdate = function (e) {
            return _this.props.onNameUpdate(_this.props.rowIndex, e.currentTarget.value);
        };
        _this.onAddCol = function () {
            return _this.props.onAddCol(_this.props.rowIndex);
        };
        _this.onDeleteRow = function () {
            return _this.props.onDeleteRow(_this.props.rowIndex);
        };
        return _this;
    }
    ...
    _createClass(RowForm, [{
        ...
        value: function render() {
            ...
            return React.createElement("fieldset", null, React.createElement("button", { type: "button", onClick: this.onDeleteRow }, "-"), React.createElement("input", { value: this.props.name, placeholder: "name", onChange: this.onNameUpdate }), this.props.values.map(function (v, i) {
                return React.createElement(_colFormContainer.ColFormContainer, { key: _this2.props.rowIndex + "-" + i, rowIndex: _this2.props.rowIndex, colIndex: i });
            }), React.createElement("button", { type: "button", onClick: this.onAddCol }, "+"));
        }
    }]);

    return RowForm;
}(React.PureComponent);
},{"react":"../node_modules/react/index.js","../containers/colFormContainer":"scripts/containers/colFormContainer.ts"}],"scripts/containers/rowFormContainer.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RowFormContainer = undefined;

var _reactRedux = require("react-redux");

var _pairwise = require("../modules/pairwise");

var _rowForm = require("../components/rowForm");
...
var dispatchToProps = {
    onAddCol: _pairwise.addCol,
    onAddRow: _pairwise.addRow,
    onDeleteRow: _pairwise.deleteRow,
    onNameUpdate: _pairwise.updateRowName
};
var RowFormContainer = exports.RowFormContainer = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(_rowForm.RowForm);
},{"react-redux":"../node_modules/react-redux/es/index.js","../modules/pairwise":"scripts/modules/pairwise.ts","../components/rowForm":"scripts/components/rowForm.tsx"}],"scripts/components/modelForm.tsx":[function(require,module,exports) {
"use strict";
...
var _rowFormContainer = require("../containers/rowFormContainer");
...
var ModelForm = exports.ModelForm = function (_React$PureComponent) {
    _inherits(ModelForm, _React$PureComponent);

    function ModelForm() {
        _classCallCheck(this, ModelForm);

        var _this = _possibleConstructorReturn(this, (ModelForm.__proto__ || Object.getPrototypeOf(ModelForm)).apply(this, arguments));

        _this.onSubmit = function (e) {
            e.preventDefault();
            // this.props.onSubmit();
        };
        _this.onAddRow = function () {
            return _this.props.onAddRow();
        };
        return _this;
    }
    ...
    _createClass(ModelForm, [{
        key: "render",
        value: function render() {
            return React.createElement("form", { onSubmit: this.onSubmit }, this.props.parameters.map(function (p, i) {
                return React.createElement(_rowFormContainer.RowFormContainer, { rowIndex: i, key: i });
            }), React.createElement("button", { type: "button", onClick: this.onAddRow }, "++"));
        }
    }]);

    return ModelForm;
}(React.PureComponent);
},{"react":"../node_modules/react/index.js","../containers/rowFormContainer":"scripts/containers/rowFormContainer.ts"}],"scripts/containers/modelFormContainer.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ModelFormContainer = undefined;
...
var stateToProps = function stateToProps(store) {
    return {
...
var ModelFormContainer = exports.ModelFormContainer = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(_modelForm.ModelForm);
},{"react-redux":"../node_modules/react-redux/es/index.js","../components/modelForm":"scripts/components/modelForm.tsx","../modules/pairwise":"scripts/modules/pairwise.ts"}],"scripts/components/app.tsx":[function(require,module,exports) {
"use strict";
...
var _modelFormContainer = require("../containers/modelFormContainer");

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function App() {
    return React.createElement(React.Fragment, null, React.createElement("div", null, React.createElement("h2", null, "TestModels"), React.createElement(_modelFormContainer.ModelFormContainer, null)));
}
},{"react":"../node_modules/react/index.js","../containers/modelFormContainer":"scripts/containers/modelFormContainer.ts"}],"scripts/main.tsx":[function(require,module,exports) {
"use strict";
...
var initStore = {
    pairwise: (0, _pairwise.initPairwiseStore)()
};
var store = (0, _redux.createStore)((0, _redux.combineReducers)({
    pairwise: _pairwise.pairwiseReducer
}), initStore);
ReactDOM.render(React.createElement(_reactRedux.Provider, { store: store }, React.createElement(_app.App, null)), document.getElementById("app"));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","redux":"../node_modules/redux/es/redux.js","./modules/pairwise":"scripts/modules/pairwise.ts","./components/app":"scripts/components/app.tsx","react-redux":"../node_modules/react-redux/es/index.js"}],"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/main.tsx"], null)
//# sourceMappingURL=/main.4d3ad3c5.map